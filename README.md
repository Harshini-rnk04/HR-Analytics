...
HR Data Develop a Power BI project focused on HR data for a company facing challenges in comprehending their employee data to extract valuable insights. Construct a comprehensive dashboard that includes the following components: Summary Page: 
...
•	Incorporate a visual element indicating the date and time of the Last Refresh of the Data
last data refresh. 
